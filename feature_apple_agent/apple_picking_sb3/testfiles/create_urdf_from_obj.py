...
OBJ_FOLDER = "/home/robben/" + os.path.join('meshes_and_urdf', 'meshes', 'trees', in_folder)
OBJ_out_FOLDER = "/home/robben/" + os.path.join('meshes_and_urdf', 'urdf', 'trees', out_folder)
